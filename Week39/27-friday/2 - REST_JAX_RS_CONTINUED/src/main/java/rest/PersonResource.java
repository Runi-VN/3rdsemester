...
public class PersonResource {
    ...
    @GET
    @Produces({MediaType.APPLICATION_JSON})
    public String getAllPersonsWeek2() throws PersonNotFoundException {
        return GSON.toJson(new PersonsDTO_week2(facade.getAllPersons()));
    }
